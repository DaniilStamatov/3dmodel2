...
namespace Assets.Scripts.Components.Model.Definitions.Editor
{
    [CustomPropertyDrawer(typeof(InventoryIdAtribute))]
    public class InventoryIdAtributeEditor : PropertyDrawer
    {
